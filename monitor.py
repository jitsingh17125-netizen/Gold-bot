...
IMPORTANT: this version only uses the FREE /v1/goldprice endpoint (current
price), not the historical endpoint. It builds its own 15-minute candle
history over time, one sample per run. Because of this:
...
def fetch_price():
    """API Ninjas current gold price (free tier)."""
